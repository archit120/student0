...
int main() {
    ...
    int *data = (int*) mm_malloc(sizeof(int));*data = (int*) mm_malloc(sizeof(int));*data = (int*) mm_malloc(sizeof(int));*data = (int*) mm_malloc(sizeof(int));
    assert(data != NULL);
    (data -2)[0] = 0x162;
    mm_free(data);
    printf("malloc test successful! %d\n", data[0]);
    return 0;
}
